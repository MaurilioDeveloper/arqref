...
@XmlSeeAlso({ SOAPCorpo.class, SOAPCabecalho.class, CancelarRenegociacaoDadosREQ.class})
public class CancelarRenegociacaoREQ extends SOAPEnvelopeEconsig<CancelarRenegociacaoDadosREQ> {
