...
@XmlRootElement(name="urn:alterarValorPrazoParcelaV1")
@XmlType(
		propOrder={
			"cdCia", "cdEmpresa", "cdOrgao", "cdMatricula", "orgMatInst", 
			"nrCpfA", "nrContrato", "vlOperacao", "nrPrazo", "cdConsigA", "cdSenhaConsig", "cdUsuario", 
			"cdIdServ", "cdOrigemTrans", "cdSenhaServidor"
		})
public class AlterarValorPrazoParcelaV1DadosREQ implements Serializable {
	...
	@XmlElement(name="PRAZO", type=String.class)
