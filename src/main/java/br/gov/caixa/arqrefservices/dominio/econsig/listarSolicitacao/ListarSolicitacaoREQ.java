...
@XmlSeeAlso({ SOAPCorpo.class, SOAPCabecalho.class, ListarSolicitacaoDadosREQ.class})
public class ListarSolicitacaoREQ extends SOAPEnvelopeEconsig<ListarSolicitacaoDadosREQ> {
