package br.gov.caixa.arqrefservices.dominio.consignet.consignarEmprestimo;
...
public class ConsignarEmprestimoDadosREQ extends ConsignetDadosREQ {

	public String getOperacao() {
		return "CONSIGNAR_EMPRESTIMO";
	}
