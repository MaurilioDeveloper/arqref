...
@XmlRootElement(name="urn:cancelarContrato")
@XmlType(
		propOrder={
			"cdCia", "cdEmpresa", "cdOrgao", "cdMatricula", "orgMatInst", 
			"nrCpfA", "cdConsigA", "cdSenhaConsig", "cdUsuario",  
			"dtOperacao", "nrContrato", "dsLivre"
		})
public class CancelarContratoDadosREQ implements Serializable {
	...
	@XmlElement(name="DT_OPERACAO_A", type=String.class)
