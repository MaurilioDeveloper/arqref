...
@XmlSeeAlso({ SOAPCorpo.class, SOAPCabecalho.class, ConsultarConsignacaoDadosREQ.class})
public class ConsultarConsignacaoREQ extends SOAPEnvelopeEconsig<ConsultarConsignacaoDadosREQ> {
