...
@XmlSeeAlso({ SOAPCorpo.class, SuspenderConsignacaoDadosRET.class})
public class SuspenderConsignacaoRET extends SOAPEnvelopeResposta<SuspenderConsignacaoDadosRET> {
