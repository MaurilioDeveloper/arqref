...
public class ConsumidorRenovarContratoV1 extends WSConsumidor{
	
	private String xmlREQ;

	public ConsumidorRenovarContratoV1(String URL, RenovarContratoV1DadosREQ dadosREQ) {
		super(URL);
		RenovarContratoV1REQ servicoSOAP = new RenovarContratoV1REQ();
		SOAPCorpo<RenovarContratoV1DadosREQ> corpoSOAP = new SOAPCorpo<RenovarContratoV1DadosREQ>();
		servicoSOAP.setBody(corpoSOAP);
		corpoSOAP.setDados(dadosREQ);
		this.xmlREQ = ConverterXML.convertToXml(servicoSOAP, RenovarContratoV1REQ.class);
	}

	public RenovarContratoV1SaidaTO executarServico()
		...
		//LENDO O ENVELOPE
		RenovarContratoV1RET soapRet = ConverterXML.converterXmlSemSanitizacao(
				retorno, RenovarContratoV1RET.class);
		...
		RenovarContratoV1SaidaTO ret = ConverterXML
				.converterXmlSemSanitizacao(resposta, RenovarContratoV1SaidaTO.class);
