...
@XmlSeeAlso({ SOAPCorpo.class, SOAPCabecalho.class, RenegociarConsignacaoDadosREQ.class})
public class RenegociarConsignacaoREQ extends SOAPEnvelopeEconsig<RenegociarConsignacaoDadosREQ> {
