package br.gov.caixa.arqrefservices.dominio.consignet.reservaComposta;
...
public class ReservaCompostaDadosREQ extends ConsignetDadosREQ {

	public String getOperacao() {
		return "RESERVA_COMPOSTA";
	}
