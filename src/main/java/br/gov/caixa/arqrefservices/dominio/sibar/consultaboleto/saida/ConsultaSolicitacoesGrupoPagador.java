...
public class ConsultaSolicitacoesGrupoPagador {

    @XmlElement(name = "QUANTIDADE_PAGINAS")
    protected int quantidadepaginas;
    
    @XmlElement(name = "SOLICITACOES")
    protected SolicitacoesGrupoPagador solicitacoes;

	public int getQuantidadepaginas() {
		return quantidadepaginas;
	}

	public SolicitacoesGrupoPagador getSolicitacoes() {
		return solicitacoes;
	}
	...
	public void setSolicitacoes(SolicitacoesGrupoPagador solicitacoes) {
