...
@XmlRootElement(name="hos:listarSolicitacao")
@XmlType(propOrder = { "cliente", "convenio", "usuario", "senha", "adeNumero",
		"adeIdentificador", "matricula", "cpf","orgaoCodigo","estabelecimentoCodigo"})
public class ListarSolicitacaoDadosREQ implements Serializable {
