...
@XmlSeeAlso({ SOAPCorpo.class, SOAPCabecalho.class, ConsultarMargemPorCPFDadosREQ.class})
public class ConsultarMargemPorCPFREQ extends SOAPEnvelopeSerpro<ConsultarMargemPorCPFDadosREQ> {
