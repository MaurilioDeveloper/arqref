...
@XmlRootElement(name="ns10:alongarConsignacaoResponse")
@XmlType(propOrder={"sucesso","codRetorno","mensagem","boleto","historicos","resumos","servicos"})
@XmlSeeAlso({Boleto.class,Historico.class,Resumo.class,Servico.class})
public class AlongarConsignacaoDadosRET implements Serializable {
