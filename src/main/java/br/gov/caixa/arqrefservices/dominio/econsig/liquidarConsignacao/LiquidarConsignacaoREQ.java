...
@XmlSeeAlso({ SOAPCorpo.class, SOAPCabecalho.class, LiquidarConsignacaoDadosREQ.class})
public class LiquidarConsignacaoREQ extends SOAPEnvelopeEconsig<LiquidarConsignacaoDadosREQ> {
